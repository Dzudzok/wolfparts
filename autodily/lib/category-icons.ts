...
const CATEGORY_IMAGES: Record<string, string> = {
  ...
  // Motor subcategories — must be before generic "řízen" and "motor"
  "řízení motoru": "/categories/subcats/motor/rizeni-motoru.png",
  "řízen": "/categories/rizeni.jpg",
  "rizen": "/categories/rizeni.jpg",
  // Brake subcategories (must be before generic "brzd")
  "brzdové obložení": "/categories/subcats/brzdy/brzdove-oblozeni.jpg",
  "brzdový kotouč": "/categories/subcats/brzdy/brzdove-oblozeni.jpg",
  "kotoučová brzda": "/categories/subcats/brzdy/brzdove-oblozeni.jpg",
  "souprava brzd": "/categories/subcats/brzdy/souprava-brzd-kotouc.jpg",
  "brzdový třmen": "/categories/subcats/brzdy/brzdovy-trmen.jpg",
  "třmen montáž": "/categories/subcats/brzdy/brzdovy-trmen-montaz.jpg",
  "bubnová brzda": "/categories/subcats/brzdy/bubnova-brzda.jpg",
  "brzdový buben": "/categories/subcats/brzdy/brzdovy-buben.jpg",
  "obložení/ čelist": "/categories/subcats/brzdy/brzdove-oblozeni-celist.jpg",
  "čelist": "/categories/subcats/brzdy/brzdove-oblozeni-celist.jpg",
  "parkovací brzda": "/categories/subcats/brzdy/parkovaci-brzda.jpg",
  "brzdový váleček": "/categories/subcats/brzdy/brzdovy-valecek.jpg",
  "brzdové hadičky": "/categories/subcats/brzdy/brzdove-hadicky.jpg",
  "brzdové potrubí": "/categories/subcats/brzdy/brzdove-potrubi.jpg",
  "posilovač brzd": "/categories/subcats/brzdy/posilovac-brzd.jpg",
  "hlavní brzdový válec": "/categories/subcats/brzdy/hlavni-brzdovy-valec.jpg",
  "nádrž na brzdovou": "/categories/subcats/brzdy/nadrz-kapaliny.jpg",
  "regulátor brzdné": "/categories/subcats/brzdy/regulator-brzdne-sily.jpg",
  "spínač brzdového": "/categories/subcats/brzdy/spinac-brzdoveho-svetla.jpg",
  "brzdová kapalina": "/categories/subcats/brzdy/brzdova-kapalina.jpg",
  "vysoce výkonné": "/categories/subcats/brzdy/vysoko-vykonny.jpg",
  "výkonná-brzdná souprava": "/categories/subcats/brzdy/vysoko-vykonny.jpg",
  "výkonný-brzdový kotouč": "/categories/subcats/brzdy/vysoko-kotouc.jpg",
  ...
  "ventil, seřízení": "/categories/subcats/motor/ventil.jpg",
  "elektrický systém": "/categories/subcats/motor/elektricky-system.jpg",
  "upevnění motoru": "/categories/subcats/motor/upevneni-motoru.png",
  "držák motoru": "/categories/subcats/motor/drzak-motoru.png",
  "uložení motoru": "/categories/subcats/motor/ulozeni-motoru.jpg",
  "tlumič motoru": "/categories/subcats/motor/tlumic-motoru.png",
  "regulace složení": "/categories/subcats/motor/egr.jpg",
  "recirkulace výfuk": "/categories/subcats/motor/egr.jpg",
  "agr kontrola": "/categories/subcats/motor/egr.jpg",
  "ventil pro řízení podtlaku": "/categories/subcats/motor/ventil-podtlak.jpg",
  "ventil, recirkulace": "/categories/subcats/motor/ventil-recirkulace.jpg",
  "kompletní motor": "/categories/subcats/motor/kompletni-motor.png",
  "neúplný motor": "/categories/subcats/motor/shortblock.jpg",
  "shortblock": "/categories/subcats/motor/shortblock.jpg",
  "kryt motoru": "/categories/subcats/motor/kryt-motoru.png",
  "ochrana proti podjet": "/categories/subcats/motor/ochrana-podjeti.jpg",
  "řemenový pohon": "/categories/subcats/motor/remenovy-pohon.png",
  "klínový řemen": "/categories/subcats/motor/klinovy-remen.jpg",
  "sada klínového": "/categories/subcats/motor/sada-klinoveho.jpg",
  "klínový žebrovaný": "/categories/subcats/motor/zebrovany-remen.jpg",
  "žebrovaný řemen": "/categories/subcats/motor/zebrovany-remen.jpg",
  "ozubený klínový": "/categories/subcats/motor/ozubeny-klinovy.jpg",
  "sada žebrovaných": "/categories/subcats/motor/sada-zebrovanych.jpg",
  "napínák řemene": "/categories/subcats/motor/napinak-remene.jpg",
  "napínání": "/categories/subcats/motor/napinak-remene.jpg",
  "ozubený řemen": "/categories/subcats/motor/ozubeny-remen.jpg",
  "sada rozvodového": "/categories/subcats/motor/sada-rozvodoveho.jpg",
  "rozvodový řemen": "/categories/subcats/motor/sada-rozvodoveho.jpg",
  "kryt ozubeného": "/categories/subcats/motor/kryt-ozubeneho.jpg",
  "válce / písty": "/categories/subcats/motor/valce-pisty.jpg",
  "válce": "/categories/subcats/motor/valce-pisty.jpg",
  "písty": "/categories/subcats/motor/valce-pisty.jpg",
  "těsnění pod hlavu": "/categories/subcats/motor/tesneni-hlava.jpg",
  "těsnění sběrného": "/categories/subcats/motor/tesneni-vyfuk.jpg",
  "těsnění výfuk": "/categories/subcats/motor/tesneni-vyfuk.jpg",
  "těsnění palivové": "/categories/subcats/motor/tesneni-palivo.jpg",
  "těsnění sacího": "/categories/subcats/motor/tesneni-saci.jpg",
  "těsnění turbodmychadla": "/categories/subcats/motor/tesneni-turbo.jpg",
  "těsnění krytu": "/categories/subcats/motor/tesneni-krytu.jpg",
  "těsnění olejové": "/categories/subcats/motor/tesneni-olejvana.jpg",
  "těsnění chladicí": "/categories/subcats/motor/tesneni-chlazeni.jpg",
  "těsnění": "/categories/subcats/motor/tesneni.jpg",
  // Filter subcategories (must be before generic "filtr")
  "olejový filtr": "/categories/subcats/filtr-olejovy.jpg",
  "vzduchový filtr": "/categories/subcats/filtr-vzduchovy.jpg",
  "palivový filtr": "/categories/subcats/filtr-palivovy.jpg",
  "kabinový": "/categories/subcats/filtr-kabinovy.jpg",
  "filtr chladiva": "/categories/subcats/filtr-chladiva.jpg",
  "hydraulický filtr": "/categories/subcats/filtr-hydraulicky.jpg",
  "filtr močoviny": "/categories/subcats/filtr-mocoviny.jpg",
  ...
  "elektroinstalace": "/categories/elektroinstalace.jpg",
  "elektro": "/categories/elektro.jpg",
  "zapalov": "/categories/zapalovani.jpg",
  "žhavicí": "/categories/zapalovani.jpg",
  "lambd": "/categories/lambda.jpg",
  "olej": "/categories/oleje.jpg",
  "osvětl": "/categories/osvetleni.jpg",
  "světl": "/categories/osvetleni.jpg",
  "motor": "/categories/motor-main.png",
  ...
  "tažné": "/categories/tazne.jpg",
  "zamykac": "/categories/zamykaci.jpg",
  "servis": "/categories/servis.jpg",
  "kontrol": "/categories/servis.jpg",
  "údržb": "/categories/servis.jpg",
  // Generic brake — MUST be last (after all specific brake subcats above)
