  ...
  return (
    <div className="mb-6">
      ...
      {filtered.length > maxItems && (
        ...
        >
          {expanded ? "Zobrazit mene" : `Zobrazit vse (${filtered.length})`}
        </button>
      )}
    </div>
  );
    ...
    <div>
      {brandFacet && brandFacet.counts.length > 0 && (
        <FacetSection
          ...
          activeValue={activeFilters.brand as string | undefined}
          field="brand"
          maxItems={20}
          searchable
      ...
      {categoryFacet && categoryFacet.counts.length > 0 && (
        <FacetSection
          ...
          activeValue={activeFilters.category as string | undefined}
          field="category"
          maxItems={15}
          onSelect={handleSelect}
        />
      ...
      {assortmentFacet && assortmentFacet.counts.length > 0 && (
        <FacetSection
          ...
          activeValue={activeFilters.assortment as string | undefined}
          field="assortment"
          maxItems={10}
          onSelect={handleSelect}
        />
